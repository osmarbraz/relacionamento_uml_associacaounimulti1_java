# Exemplo de implementação de relacionamento associação unidirecional e multiplicidade 1 em Java.

## Contextualização

- Programa em Java que demostra a implementação do relacionamento associação unidimensional "usa" com multiplicidade 1.<br>
...
- O projeto foi desenvolvido no NetBeans deve ser chamado relacionamento_uml_associacaounimulti1_java.<br>
